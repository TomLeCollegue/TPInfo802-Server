 ...
 * 
 */
@WebServiceClient(name = "SOAPServerService", targetNamespace = "http://server/", wsdlLocation = "http://89.87.13.28:55807/serveurSOAP_war/soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVERSERVICE_QNAME = new QName("http://server/", "SOAPServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://89.87.13.28:55807/serveurSOAP_war/soap?wsdl");
    ...
    public SOAPServer getSOAPServerPort() {
        return super.getPort(new QName("http://server/", "SOAPServerPort"), SOAPServer.class);
    }
    ...
    public SOAPServer getSOAPServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "SOAPServerPort"), SOAPServer.class, features);
    }
